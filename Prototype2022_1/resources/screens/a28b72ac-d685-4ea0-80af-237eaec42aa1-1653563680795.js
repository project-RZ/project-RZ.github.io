jQuery("#simulation")
  .on("click", ".s-a28b72ac-d685-4ea0-80af-237eaec42aa1 .click", function(event, data) {
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/a28b72ac-d685-4ea0-80af-237eaec42aa1",
                    "transition": {
                      "type": "slideright",
                      "duration": 700
                    }
  ...
  .on("swipeleft", ".s-a28b72ac-d685-4ea0-80af-237eaec42aa1 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("swiperight", ".s-a28b72ac-d685-4ea0-80af-237eaec42aa1 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/5f7c7a1f-a824-41cb-853f-0a98ae9ff257",
                    "transition": {
                      "type": "slideright",
                      "duration": 700
                    }
