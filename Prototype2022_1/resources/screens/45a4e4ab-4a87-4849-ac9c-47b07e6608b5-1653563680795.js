jQuery("#simulation")
  .on("click", ".s-45a4e4ab-4a87-4849-ac9c-47b07e6608b5 .click", function(event, data) {
  ...
  .on("swipeleft", ".s-45a4e4ab-4a87-4849-ac9c-47b07e6608b5 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("swiperight", ".s-45a4e4ab-4a87-4849-ac9c-47b07e6608b5 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
