jQuery("#simulation")
  .on("click", ".s-d4ea6111-7622-469f-bb05-87c19394d111 .click", function(event, data) {
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/ef11ab36-a40d-4ac7-8b8f-d2851a886c88",
                    "transition": {
                      "type": "slideright",
                      "duration": 700
                    }
  ...
  .on("swipeleft", ".s-d4ea6111-7622-469f-bb05-87c19394d111 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("swiperight", ".s-d4ea6111-7622-469f-bb05-87c19394d111 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
