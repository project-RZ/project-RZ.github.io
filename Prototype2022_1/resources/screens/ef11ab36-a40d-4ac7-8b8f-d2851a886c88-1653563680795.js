jQuery("#simulation")
  .on("click", ".s-ef11ab36-a40d-4ac7-8b8f-d2851a886c88 .click", function(event, data) {
  ...
  .on("swipeleft", ".s-ef11ab36-a40d-4ac7-8b8f-d2851a886c88 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("swiperight", ".s-ef11ab36-a40d-4ac7-8b8f-d2851a886c88 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
