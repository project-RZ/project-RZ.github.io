jQuery("#simulation")
  .on("click", ".s-6bb97e9b-a323-433f-86fc-bec90a509aa2 .click", function(event, data) {
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/d4ea6111-7622-469f-bb05-87c19394d111",
                    "transition": {
                      "type": "slideright",
                      "duration": 700
                    }
  ...
  .on("swipeleft", ".s-6bb97e9b-a323-433f-86fc-bec90a509aa2 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("swiperight", ".s-6bb97e9b-a323-433f-86fc-bec90a509aa2 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
